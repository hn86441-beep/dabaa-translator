...
# ════════════════════════════════════════════════════════════
#  4. إعدادات الصفحة (بحجم الشاشة الأصلي)
# ════════════════════════════════════════════════════════════
st.set_page_config(
    page_title="HN TRANSLATOR",
    page_icon="🌐",
    layout="centered"  # عدلت إلى centered بدلاً من wide
)
...
# ════════════════════════════════════════════════════════════
#  6. CSS (مع الحفاظ على الحجم الأصلي)
# ════════════════════════════════════════════════════════════
st.markdown("""
<style>
...
.light-mode .app-header h1 { color: #1a1a2e; }
.light-mode .app-header h1 .accent { color: #2a7a60; }
.light-mode .stButton > button { background: linear-gradient(135deg, #2a7a60 0%, #1a5a48 100%) !important; color: white !important; }
.light-mode textarea { background: white !important; color: #1a1a2e !important; border: 1px solid #ddd !important; }
.light-mode .result-box .text { color: #1a1a2e; }
.light-mode .result-box .emotion { color: #2a7a60; }
.light-mode .stSelectbox > div > div { background: white !important; color: #1a1a2e !important; }
.light-mode [data-testid="stSidebar"] { background: rgba(255,255,255,0.95) !important; }
.light-mode [data-testid="stSidebar"] .stMarkdown { color: #1a1a2e !important; }
.light-mode .history-item .text { color: #1a1a2e; }
.light-mode .history-item .lang { color: #2a7a60; }
.light-mode .history-item .time { color: #888; }
.light-mode .stSuccess { background: #e8f5e9 !important; color: #1a5a48 !important; }
.light-mode .stError { background: #ffebee !important; color: #c0392b !important; }
...
# تطبيق الوضع الفاتح/الداكن عبر JavaScript
if st.session_state.theme == "light":
    st.markdown('<script>document.body.classList.add("light-mode");</script>', unsafe_allow_html=True)
else:
    st.markdown('<script>document.body.classList.remove("light-mode");</script>', unsafe_allow_html=True)
...
# ════════════════════════════════════════════════════════════
#  8. الشريط الجانبي: زر تبديل المظهر + سجل الترجمات
# ════════════════════════════════════════════════════════════
with st.sidebar:
    st.markdown("## 🌓 المظهر")
