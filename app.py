...
# ════════════════════════════════════════════════════════════
#  6. CSS للوضع الفاتح والداكن (يتم تطبيقه حسب session_state.theme)
# ════════════════════════════════════════════════════════════
def get_css(theme):
    if theme == "light":
        return """
        ...
        .app-header h1 { color: #1a1a2e; }
        .app-header h1 .accent { color: #2a7a60; }
        .stButton > button { background: linear-gradient(135deg, #2a7a60 0%, #1a5a48 100%) !important; color: white !important; }
        textarea { background: white !important; color: #1a1a2e !important; border: 1px solid #ddd !important; }
        .result-box .text { color: #1a1a2e; }
        .result-box .emotion { color: #2a7a60; }
        .stSelectbox > div > div { background: white !important; color: #1a1a2e !important; }
        [data-testid="stSidebar"] { background: rgba(255,255,255,0.95) !important; }
        [data-testid="stSidebar"] .stMarkdown { color: #1a1a2e !important; }
        .history-item .text { color: #1a1a2e; }
        .history-item .lang { color: #2a7a60; }
        ...
        .result-box .text { color: #e8f0ff; }
        .result-box .emotion { color: #4ECBA0; }
        .stSelectbox > div > div { background: rgba(255,255,255,0.05) !important; color: #e8f0ff !important; }
        [data-testid="stSidebar"] { background: rgba(10,10,26,0.95) !important; }
        [data-testid="stSidebar"] .stMarkdown { color: #e8f0ff !important; }
        .history-item .text { color: #e8f0ff; }
        .history-item .lang { color: #4ECBA0; }
        .history-item .time { color: rgba(180,200,230,0.4); }
...
# ════════════════════════════════════════════════════════════
#  8. الشريط الجانبي: زر تبديل المظهر + سجل الترجمات (من قاعدة البيانات)
# ════════════════════════════════════════════════════════════
with st.sidebar:
    # --- زر تبديل المظهر ---
    st.markdown("## 🌓 المظهر")
    ...
    if history:
        ...
        for item in history:
            ...
            <div class="history-item">
                ...
                <div class="text" style="color: {'#2a7a60' if st.session_state.theme == 'light' else '#4ECBA0'};">→ {item.get('translated', '')[:50]}...</div>
                <div class="lang">
